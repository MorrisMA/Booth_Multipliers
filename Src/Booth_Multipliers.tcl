# 
# Project automation script for Booth_Multipliers 
# 
# Created for ISE version 10.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source Booth_Multipliers.tcl, then you can
...
set myProject "Booth_Multipliers.ise"
set myScript "Booth_Multipliers.tcl"
...
proc add_source_files {} {
   ...
   xfile add "Booth_Multiplier.ucf"
   xfile add "Booth_Multiplier.v"
   xfile add "Booth_Multiplier_1xA.v"
   xfile add "Booth_Multiplier_2x.v"
   xfile add "Booth_Multiplier_4x.v"
   xfile add "Booth_Multiplier_4xA.v"
   xfile add "tb_Booth_Multiplier.v"
   xfile add "tb_Booth_Multiplier_1xA.v"
   xfile add "tb_Booth_Multiplier_2x.v"
   xfile add "tb_Booth_Multiplier_4x.v"
   xfile add "tb_Booth_Multiplier_4xA.v"

   # Set the Top Module as well...
   project set top "Booth_Multiplier"
...
proc set_process_props {} {
   ...
   project set "SmartGuide Filename" "Booth_Multiplier_guide.ncd"
